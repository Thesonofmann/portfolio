...
import profilePic from "../Newwww.png";
...
const Hero = () => {
  return <div className="border-b border-neutral-900 pb-4 lg:mb-35" id="home">
    <div className="flex flex-wrap pt-40">
      <div className="w-full lg:w-1/2">
        <div className="flex flex-col items-center lg:items-start">
          ...
          initial= "hidden"
          animate= "visible"
          className="pb-16 text-4xl font-thin tracking-tight lg:text-5xl lg:mt-16">
          Jeremiah Ashogbon
          </motion.h1>
          <motion.span 
      ...
      <div className="w-full lg:w-1/2 lg:p-8">
        ...
        className="flex justify-center">
          ...
          className=" mix-blend-mode-overlay w-[30rem] h-[27rem]" />
        </motion.div>
      </div>
    </div>
